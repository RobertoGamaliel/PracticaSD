    ...
    return (
      <div className='row pt-3 pb-3'>
        ...
        <div className="col-md-6 ">
          <div class="alert alert-warning shadow text-center" role="alert">
            {this.state.errores}
          </div>
        </div>
        <div className="col-md-3 "></div>
        ...
        <div className="col-md-4 p-5 mb-5">
          <div className="card card-body rounded shadow">
            ...
            <form onSubmit={this.onSubmit}>
              ...
              <button type="submit" className="btn btn-primary ms-5 mt-3" id='botonGuardar'>
                CREAR NUEVO USUARIO
              </button>
            </form>
          </div>
